...
local function OP_Call2(op, ax, bx)
  ...
  local function func(a, b)
    ...
    if have and ret ~= NotImplemented then -- [LINE 302]
      return ret; -- [LINE 303]
    end;
    if bx ~= nil then -- [LINE 305]
      have, ret = unpack(safemetacall(a, bx, b)); -- [LINE 306]
      if have and ret ~= NotImplemented then -- [LINE 307]
        return ret; -- [LINE 308]
      end;
    end;
    have, ret = unpack(safemetacall(b, ax, a)); -- [LINE 310]
    if have and ret ~= NotImplemented then -- [LINE 311]
      return ret; -- [LINE 312]
    end;
    error(lua.concat("Can't do '", op, "'")); -- [LINE 314]
  end;
  return func; -- [LINE 316]
end;
_OP__Add__ = OP_Call2('+', 'add', 'radd'); -- [LINE 319]
_OP__Sub__ = OP_Call2('-', 'sub', 'rsub'); -- [LINE 320]
local x = list({int(1), int(2), int(3)}); -- [LINE 322]
local y = int(5); -- [LINE 323]
local z = int(7); -- [LINE 324]
print(x); -- [LINE 325]
print(_OP__Add__(y, z)); -- [LINE 326]
